...
class NaverMusicAgent(Agent.Artist):
    ...
    def search(self, results, media, lang, manual):
        ...
        # Search for artist.
        Log.Info('Artist search: ' + media.artist)
        if manual:
            Log.Info('Running custom search...')

        artists = self.score_artists(media, lang, SearchArtists(media.artist))
        Log.Info('Found ' + str(len(artists)) + ' artists...')
